...
plot=sns.barplot(y=feature_importances['Variabili'], x=feature_importances['Importanza'], orient="h", palette = "CMRmap").set_title("Feature Importance %s" %anno, fontdict={'fontsize':15})
st.write(fig2)
